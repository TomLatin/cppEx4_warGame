...
namespace WarGame {
    ...
    public:
        ...
        //help functions
        void checkLegalSrc(std::pair<int, int> source ,uint player_number);
        void checkLegalDest(std::pair<int, int> dest);
        std::pair<int, int> getDest( std::pair<int, int> source,MoveDIR direction);
